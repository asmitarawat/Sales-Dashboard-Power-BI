...
### Project Overview
An interactive Sales Performance Dashboard built in Power BI using the popular Superstore dataset from Kaggle. This dashboard analyzes over **5,000 orders and $2.26M in total sales** across regions, product categories, and time periods — helping business stakeholders make data-driven decisions at a glance.
...
📊 Dashboard Features
KPI Cards
MetricValueTotal Sales$2,297,200Total Orders9,994Total Customers793Avg Order Value$230
Visuals Built
